...
function engine() {
  ...
  function loadLibrary(deviceId, libraryLocation, locationPath, preload, newDelayedRegistration, newLicenseKey, deviceModelName) {
    ...
    Module = {
      ...
      instantiateWasm: function instantiateWasm(importObject, successCallback) {
        ...
        if (wasmJSVersion !== "5.4.2") {
          console.error("The Scandit SDK Engine library JS file found at ".concat(jsURI, " seems invalid: ") + "expected version doesn't match (received: ".concat(wasmJSVersion, ", expected: ", "5.4.2", "). ") + "Please ensure the correct Scandit SDK Engine file (with correct version) is retrieved.");
        }
  ...
  function getLibraryLocationURIs(libraryLocation) {
    ...
    if (/^https?:\/\/([^\/.]*\.)*cdn.jsdelivr.net\//.test(libraryLocation)) {
      libraryLocation = "https://cdn.jsdelivr.net/npm/scandit-sdk@5.4.2/build/";
      cdnURI = true;
    } else if (/^https?:\/\/([^\/.]*\.)*unpkg.com\//.test(libraryLocation)) {
      libraryLocation = "https://unpkg.com/scandit-sdk@5.4.2/build/";
      cdnURI = true;
    }
    ...
    return {
      jsURI: "".concat(libraryLocation, "scandit-engine-sdk.min.js?v=5.4.2"),
      wasmURI: "".concat(libraryLocation, "scandit-engine-sdk.wasm?v=5.4.2")
    };
  }
    ...
    function verifyResponseData(responseData) {
      ...
      if (typeof ((_crypto = crypto) === null || _crypto === void 0 ? void 0 : (_crypto$subtle = _crypto.subtle) === null || _crypto$subtle === void 0 ? void 0 : _crypto$subtle.digest) === "function") {
        crypto.subtle.digest("SHA-256", responseData).then(function (hash) {
          ...
          if (hashString !== "25cf136156d252d1ae211690c31e551a9c8ae8f02ae30401a7f7949a27cb8e81") {
            console.error("The Scandit SDK Engine library WASM file found at ".concat(wasmURI, " seems invalid: ") + "expected file hash doesn't match (received: ".concat(hashString, ", ") + "expected: ".concat("25cf136156d252d1ae211690c31e551a9c8ae8f02ae30401a7f7949a27cb8e81", "). ") + "Please ensure the correct Scandit SDK Engine file (with correct version) is retrieved.");
          }
        }).catch(
        /* istanbul ignore next */
        function () {// Ignored
...
BlurryRecognitionPreloader.blurryTableFiles = ["/1a3f08f42d1332344e3cebb5c53d9837.scandit", "/32e564a3408a1555c8e1c437fee00d36.scandit", "/3d90c055e483d26cc356c4a9e1b1fb37.scandit", "/5f91576bc7215e09de2c145cccca50de.scandit", "/e078b48a2b083e551246567e8cdf1b9c.scandit", "/eadf9b9d40ca243665e4ee7cbd7ba109.scandit", "/58c55d55c191d83754ff25398170a396.scandit", "/98908cb667cf64cf863486b6a7aafe8b.scandit", "/e171da0d56d58dc63b105a2f4dc5dce0.scandit", "/0ae170296d3653ad308e7fa192d42fb6.scandit", "/89dfec6b19b94e2bd9459388c7d2fefb.scandit", "/e4d5141cd8ed672df64dca4f0bd1709e.scandit", "/4243724f7555e82c259850107c30914f.scandit", "/59c85c98c5674dd1072254ea6bd6ef92.scandit", "/76ca9155b19b81b4ea4a209c9c2154a4.scandit", "/59a53ea1435408779834719fa6c2cabd.scandit", "/6fa564c6d98a4cf360aead27987f9546.scandit", "/cd5894907b6dd4d3ab237f353db43625.scandit"].map(function (path) {
...
(function (CameraAccess) {
  ...
  function sortCamerasForCameraType(cameras, cameraType) {
    if (cameras.every(function (camera) {
      ...
      cameras = cameraType === Camera.Type.FRONT ? [].concat(toConsumableArray(frontCameras), toConsumableArray(backCameras)) : [].concat(toConsumableArray(backCameras), toConsumableArray(frontCameras));
    } else {
  ...
  function extractAccessibleCamerasFromDevices(devices) {
    function createCamera(videoDevice, index, videoDevices) {
      ...
      if (videoDevices.every(function (device) {
        ...
        cameraType = videoDevices.length === 1 || index + 1 <= videoDevices.length / 2 ? Camera.Type.FRONT : Camera.Type.BACK;
      } else {
    ...
    }).map(createCamera).map(function (camera) {
      ...
      return regenerator.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              availableDevices = _context.sent;

              if (!availableDevices.filter(function (device) {
                return device.kind === "videoinput";
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              ...
              oldAvailableDevices = (_availableDevices = availableDevices) !== null && _availableDevices !== void 0 ? _availableDevices : [];
              availableDevices = [];
              _context2.prev = 7;
              _context2.next = 10;
            ...
            case 15:
              availableDevices = _context2.sent;

            case 16:
              (_console = console).debug.apply(_console, ["Camera list (devices):"].concat(toConsumableArray(availableDevices)));
  ...
  function _accessCameraStream() {
    _accessCameraStream = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(resolutionFallbackLevel, camera) {
  ...
  function _enumerateDevices() {
    _enumerateDevices = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4() {
      var _window$MediaStreamTr, devices;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              return _context4.abrupt("return", navigator.enumerateDevices());
            ...
            case 4:
              ...
              return _context4.abrupt("return", navigator.mediaDevices.enumerateDevices());
...
var CameraManager = /*#__PURE__*/function () {
  ...
  createClass(CameraManager, [{
    ...
    value: function () {
      var _setupCamerasAndStream = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee10() {
        ...
        return regenerator.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 3:
                mediaStreamTrack = _context10.sent;
                _context10.next = 6;
                return CameraAccess.getCameras();

              case 6:
                cameras = _context10.sent;
                ...
                wantedCamera = CameraAccess.adjustCamerasFromCameraStream(mediaStreamTrack, cameras, this.cameraType);
                ...
                console.debug("Initial camera access was incorrect, change camera");
                _context10.next = 22;
                break;

              case 14:
                console.debug("Initial camera access was correct, keep camera:", wantedCamera);
                this.setSelectedCamera(wantedCamera);
                this.updateActiveCameraCurrentResolution(wantedCamera); // Due to non-standard behaviour, it could happen that the stream got interrupted while getting the list of
    ...
    key: "getInitialResolutionFallbackLevel",
    value: function getInitialResolutionFallbackLevel() {
      ...
      return resolutionFallbackLevel;
    }
  }, {
    key: "accessAutoselectedCamera",
    value: function () {
      var _accessAutoselectedCamera = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee11(cameras) {
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 9:
                ...
                console.warn("Couldn't access camera:", autoselectedCamera, _context11.t0);
                autoselectedCamera = cameras.shift();
    ...
    value: function () {
      var _accessInitialCamera = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee12() {
        var primaryCamera, videoTracks;
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                ...
                _context12.prev = 2;
                _context12.next = 5;
                return this.initializeCameraWithSettings(primaryCamera, this.selectedCameraSettings);
              ...
              case 5:
                ...
                return _context12.abrupt("return", videoTracks[0]);
    ...
    value: function () {
      var _videoTrackEndedRecovery = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee13() {
    ...
    value: function () {
      var _videoTrackMuteRecovery = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee14() {
    ...
    value: function () {
      var _triggerManualFocusForContinuous = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee17() {
        var _this3 = this;
        ...
        return regenerator.wrap(function _callee17$(_context17) {
          while (1) {
            switch (_context17.prev = _context17.next) {
              case 0:
                this.manualToAutofocusResumeTimeout = window.setTimeout( /*#__PURE__*/asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee15() {
              ...
              case 3:
                this.manualFocusWaitTimeout = window.setTimeout( /*#__PURE__*/asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee16() {
    ...
    value: function () {
      var _triggerManualFocusForSingleShot = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee18() {
        var _this4 = this;
    ...
    value: function () {
      var _triggerManualFocus = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee19(event) {
    ...
    key: "triggerZoomMove",
    value: function () {
      var _triggerZoomMove = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee20(event) {
    ...
    value: function () {
      var _triggerAutoFocus = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee21() {
    ...
    value: function () {
      var _triggerFocusMode = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee22(focusMode) {
        var videoTracks;
    ...
    value: function () {
      var _initializeCameraAndCheckUpdatedSettings = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee23(camera) {
        var _this7 = this;
    ...
    value: function () {
      var _handleCameraInitializationError = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee24(camera, resolutionFallbackLevel, error) {
        ...
        return regenerator.wrap(function _callee24$(_context24) {
          while (1) {
            switch (_context24.prev = _context24.next) {
              ...
              case 3:
                if (!(error.name === "OverconstrainedError" && resolutionFallbackLevel === 4)) {
                  _context24.next = 19;
                  break;
                }
              ...
              case 17:
                ...
                return _context24.abrupt("return", this.initializeCamera(camera));

              case 19:
                return _context24.abrupt("return", this.initializeCamera(camera, resolutionFallbackLevel + 1));
    ...
    value: function () {
      var _initializeCamera = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee25(camera, resolutionFallbackLevel) {
        var _resolutionFallbackLe,
            _this8 = this;
          ...
          while (1) {
            switch (_context25.prev = _context25.next) {
              ...
              case 2:
                ...
                this.gui.setTorchTogglerVisible(false);
                (_resolutionFallbackLe = resolutionFallbackLevel) !== null && _resolutionFallbackLe !== void 0 ? _resolutionFallbackLe : resolutionFallbackLevel = this.getInitialResolutionFallbackLevel();
                _context25.prev = 6;
                _context25.next = 9;
              ...
              case 17:
                return _context25.abrupt("return", this.initializeCamera(camera, resolutionFallbackLevel + 1));
              ...
              case 18:
                ...
                return _context25.abrupt("return", this.setupCameraStreamVideo(camera, stream));

              case 23:
                _context25.prev = 23;
                _context25.t0 = _context25["catch"](6);
                return _context25.abrupt("return", this.handleCameraInitializationError(camera, resolutionFallbackLevel, _context25.t0));
    ...
    value: function () {
      var _checkCameraAccess = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee26(camera) {
        var _this9 = this;
        ...
        return regenerator.wrap(function _callee26$(_context26) {
          while (1) {
            switch (_context26.prev = _context26.next) {
              case 0:
                window.clearTimeout(this.cameraAccessTimeout);
                return _context26.abrupt("return", new promise$1(function (_, reject) {
    ...
    value: function () {
      var _checkVideoMetadata = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee27(camera) {
        var _this10 = this;
        ...
        return regenerator.wrap(function _callee27$(_context27) {
          while (1) {
            switch (_context27.prev = _context27.next) {
              case 0:
                return _context27.abrupt("return", new promise$1(function (resolve, reject) {
  ...
  createClass(Controller, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 8:
                ...
                return _context2.abrupt("return", this.handleException(_context2.t0));

              case 11:
                _context2.t1 = Proxy;
                _context2.t2 = BarcodePicker;
                _context2.t3 = this.view.root;
                _context2.t4 = this.lazyAttributeConverter[Attribute.ACCESS_CAMERA];
                _context2.next = 17;
                return this.getCameraFromAttribute();

              case 17:
                _context2.t5 = _context2.sent;
                _context2.t6 = this.lazyAttributeConverter[Attribute.CAMERA_TYPE];
                _context2.t7 = this.lazyAttributeConverter[Attribute.ENABLE_CAMERA_SWITCHER];
                _context2.t8 = this.lazyAttributeConverter[Attribute.ENABLE_PINCH_TO_ZOOM];
                _context2.t9 = this.lazyAttributeConverter[Attribute.ENABLE_TAP_TO_FOCUS];
                _context2.t10 = this.lazyAttributeConverter[Attribute.ENABLE_TORCH_TOGGLE];
                _context2.t11 = this.lazyAttributeConverter[Attribute.PLAY_SOUND_ON_SCAN];
                _context2.t12 = this.lazyAttributeConverter[Attribute.VIBRATE_ON_SCAN];
                _context2.t13 = this.lazyAttributeConverter[Attribute.SCANNING_PAUSED];
                _context2.t14 = this.lazyAttributeConverter[Attribute.GUI_STYLE];
                _context2.t15 = this.lazyAttributeConverter[Attribute.TARGET_SCANNING_FPS];
                _context2.t16 = this.lazyAttributeConverter[Attribute.VIDEO_FIT];
                _context2.t17 = this.lazyAttributeConverter[Attribute.VISIBLE];
                _context2.t18 = this.lazyAttributeConverter[Attribute.VIEWFINDER_AREA];
                _context2.t19 = this.lazyAttributeConverter[Attribute.LASER_AREA];
                _context2.next = 34;
              ...
              case 34:
                ...
                _context2.t21 = {
                  accessCamera: _context2.t4,
                  camera: _context2.t5,
                  cameraType: _context2.t6,
                  enableCameraSwitcher: _context2.t7,
                  enablePinchToZoom: _context2.t8,
                  enableTapToFocus: _context2.t9,
                  enableTorchToggle: _context2.t10,
                  playSoundOnScan: _context2.t11,
                  vibrateOnScan: _context2.t12,
                  scanningPaused: _context2.t13,
                  guiStyle: _context2.t14,
                  targetScanningFPS: _context2.t15,
                  videoFit: _context2.t16,
                  visible: _context2.t17,
                  viewfinderArea: _context2.t18,
                  laserArea: _context2.t19,
                  singleImageModeSettings: _context2.t20
                };
                _context2.next = 38;
                return _context2.t2.create.call(_context2.t2, _context2.t3, _context2.t21);

              case 38:
                _context2.t22 = _context2.sent;
                _context2.t23 = this.getBarcodePickerProxyHandler();
                this.picker = new _context2.t1(_context2.t22, _context2.t23);
    ...
    value: function onScannerNewScanSettings(scanSettings) {
      ...
      changeSet.forEach(function (change) {
        _this3.onPickerPropertyUpdate(_objectSpread$1({
          origin: "scanner"
        }, change));
      });
    }
            ...
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                if (this.lazyAttributeConverter[Attribute.SINGLE_IMAGE_MODE_SETTINGS] != null) {
                  ...
                  settings.desktop = _objectSpread$1(_objectSpread$1({}, SingleImageModeSettings.defaultDesktop), (_this$lazyAttributeCo = this.lazyAttributeConverter[Attribute.SINGLE_IMAGE_MODE_SETTINGS].desktop) !== null && _this$lazyAttributeCo !== void 0 ? _this$lazyAttributeCo : {});
                  settings.mobile = _objectSpread$1(_objectSpread$1({}, SingleImageModeSettings.defaultMobile), (_this$lazyAttributeCo2 = this.lazyAttributeConverter[Attribute.SINGLE_IMAGE_MODE_SETTINGS].mobile) !== null && _this$lazyAttributeCo2 !== void 0 ? _this$lazyAttributeCo2 : {});
    ...
    value: function validateAllAttributes() {
      ...
      var attrs = from_1$1(this.view.getAttributes());
...
var ScanditBarcodePicker = /*#__PURE__*/function (_HTMLElement) {
  ...
  createClass(ScanditBarcodePicker, [{
    ...
    value: function onError(e) {
      // tslint:disable-next-line:no-inner-html
      this.shadowDom.innerHTML = "<span style=\"color:red\">Error: ".concat(e.name, " : ").concat(e.message, "</span>");
    }
  }, {
    ...
    value: function getAttributes() {
      return from_1$1(this.attributes).map(function (att) {
        return {
          name: att.name,
          value: att.value
        };
    ...
    var _ref2 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(resolve, reject) {
      ...
      return regenerator.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              console.log("Scandit Web SDK version: 5.4.2");
...
export { Barcode, BarcodePicker, BrowserCompatibility, BrowserHelper, Camera, CameraAccess, CameraSettings, CustomError, ImageSettings, Parser, ScanResult, ScanSettings, ScanditBarcodePicker, Scanner, SingleImageModeSettings, SymbologySettings, UAParser, blurryRecognitionPreloader, configure, configurePhase, configurePromise, deviceId, engine, engineLoader, engineWorkerBlob, resetConfigure, scanditEngineLocation, userLicenseKey };
