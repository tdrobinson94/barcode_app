...
function engine() {
            ...
            instantiateWasm: function (importObject, successCallback) {
                ...
                if (wasmJSVersion !== "5.4.2") {
                    console.error("The Scandit SDK Engine library JS file found at " + jsURI + " seems invalid: " +
                        ("expected version doesn't match (received: " + wasmJSVersion + ", expected: " + "5.4.2" + "). ") +
    ...
    function getLibraryLocationURIs(libraryLocation) {
        ...
        return {
            jsURI: libraryLocation + "scandit-engine-sdk.min.js?v=5.4.2",
            wasmURI: libraryLocation + "scandit-engine-sdk.wasm?v=5.4.2",
        };
    }
    ...
    function applySettings(highQualitySingleFrameMode) {
        ...
        var settingsLength = lengthBytesUTF8(settings) + 1;
        var settingsPointer = Module._malloc(settingsLength);
        stringToUTF8(settings, settingsPointer, settingsLength);
        var resultPointer = Module._scanner_settings_new_from_json(settingsPointer, parsedSettings.blurryRecognition && blurryRecognitionAvailable, parsedSettings.matrixScanEnabled, highQualitySingleFrameMode, gpuAccelerationAvailable && parsedSettings.gpuAcceleration);
                ...
                crypto.subtle
                    ...
                    if (hashString !== "25cf136156d252d1ae211690c31e551a9c8ae8f02ae30401a7f7949a27cb8e81") {
                        console.error("The Scandit SDK Engine library WASM file found at " + wasmURI + " seems invalid: " +
                            ...
                            ("expected: " + "25cf136156d252d1ae211690c31e551a9c8ae8f02ae30401a7f7949a27cb8e81" + "). ") +
                            "Please ensure the correct Scandit SDK Engine file (with correct version) is retrieved.");
                    }
                })
                    .catch(
