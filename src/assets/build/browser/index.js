	...
	(function (CameraAccess) {
	  ...
	  function sortCamerasForCameraType(cameras, cameraType) {
	    if (cameras.every(function (camera) {
	      ...
	      cameras = cameraType === exports.Camera.Type.FRONT ? [].concat(toConsumableArray(frontCameras), toConsumableArray(backCameras)) : [].concat(toConsumableArray(backCameras), toConsumableArray(frontCameras));
	    } else {
	          ...
	          while (1) {
	            switch (_context10.prev = _context10.next) {
	              ...
	              case 6:
	                ...
	                wantedCamera = exports.CameraAccess.adjustCamerasFromCameraStream(mediaStreamTrack, cameras, this.cameraType);
	        ...
	        return regenerator.wrap(function _callee2$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              ...
	              case 11:
	                _context2.t1 = Proxy;
	                _context2.t2 = exports.BarcodePicker;
	            ...
	            switch (_context4.prev = _context4.next) {
	              case 0:
	                ...
	                if (this.lazyAttributeConverter[Attribute.SINGLE_IMAGE_MODE_SETTINGS] != null) {
	                  ...
	                  settings.desktop = _objectSpread$1(_objectSpread$1({}, exports.SingleImageModeSettings.defaultDesktop), (_this$lazyAttributeCo = this.lazyAttributeConverter[Attribute.SINGLE_IMAGE_MODE_SETTINGS].desktop) !== null && _this$lazyAttributeCo !== void 0 ? _this$lazyAttributeCo : {});
	                  settings.mobile = _objectSpread$1(_objectSpread$1({}, exports.SingleImageModeSettings.defaultMobile), (_this$lazyAttributeCo2 = this.lazyAttributeConverter[Attribute.SINGLE_IMAGE_MODE_SETTINGS].mobile) !== null && _this$lazyAttributeCo2 !== void 0 ? _this$lazyAttributeCo2 : {});
