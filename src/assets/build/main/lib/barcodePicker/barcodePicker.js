...
var BarcodePicker = /** @class */ (function () {
    function BarcodePicker(originElement, _a) {
        ...
        if (singleImageModeEnabled) {
            this.cameraManager = new dummyCameraManager_1.DummyCameraManager(this.triggerFatalError.bind(this), this.gui);
            this.gui.setCameraType(cameraType);
        }
        else {
            this.cameraManager = new cameraManager_1.CameraManager(this.triggerFatalError.bind(this), this.gui);
