...
exports.CameraManager = exports.MeteringMode = void 0;
...
var CameraManager = /** @class */ (function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!(mediaStreamTrack != null)) return [3 /*break*/, 6];
                        wantedCamera = cameraAccess_1.CameraAccess.adjustCamerasFromCameraStream(mediaStreamTrack, cameras, this.cameraType);
                        if (!(wantedCamera == null)) return [3 /*break*/, 3];
                    ...
                    case 3:
                        ...
                        if (!(mediaStreamTrack.readyState === "ended")) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.reinitializeCamera()];
                    case 4: return [2 /*return*/, _a.sent()];
                    case 5: return [2 /*return*/];
                    case 6:
                        if (!(this.selectedCamera == null)) return [3 /*break*/, 8];
                        return [4 /*yield*/, this.accessAutoselectedCamera(cameras)];
                    case 7: return [2 /*return*/, _a.sent()];
                    case 8: return [4 /*yield*/, this.initializeCameraWithSettings(this.selectedCamera, this.selectedCameraSettings)];
    ...
    CameraManager.prototype.getInitialResolutionFallbackLevel = function () {
        var _a;
    ...
    CameraManager.prototype.accessInitialCamera = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var primaryCamera, videoTracks, _a;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(this.selectedCamera == null)) return [3 /*break*/, 5];
                        primaryCamera = {
                            deviceId: "",
                            label: "",
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.initializeCameraWithSettings(primaryCamera, this.selectedCameraSettings)];
                    case 2:
                        _b.sent();
                        if (this.mediaStream != null) {
                            videoTracks = this.mediaStream.getVideoTracks();
                            if (videoTracks.length !== 0) {
                                return [2 /*return*/, videoTracks[0]];
                            }
                        }
                        return [3 /*break*/, 5];
                    case 3:
    ...
    CameraManager.prototype.handleCameraInitializationError = function (camera, resolutionFallbackLevel, error) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(error.name === "OverconstrainedError" && resolutionFallbackLevel === 4)) return [3 /*break*/, 2];
                        ...
                        // (resolutionFallbackLevel === 4), if an error still happens we know said device doesn't exist anymore
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2: return [2 /*return*/, this.initializeCamera(camera, resolutionFallbackLevel + 1)];
                }
            });
        });
    };
    CameraManager.prototype.initializeCamera = function (camera, resolutionFallbackLevel) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var stream, mediaTrackSettings, error_3;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.gui.setTorchTogglerVisible(false);
                        resolutionFallbackLevel !== null && resolutionFallbackLevel !== void 0 ? resolutionFallbackLevel : (resolutionFallbackLevel = this.getInitialResolutionFallbackLevel());
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, this.setupCameraStreamVideo(camera, stream)];
                    case 3:
                        error_3 = _a.sent();
                        return [2 /*return*/, this.handleCameraInitializationError(camera, resolutionFallbackLevel, error_3)];
                    case 4: return [2 /*return*/];
                }
            });
        });
