import { BarcodePicker, Camera, SearchArea } from "..";
...
declare type AttributeType = "boolean" | "string" | "integer" | "array" | "videoFit" | "camera" | "cameraSettings" | "cameraType" | "guiStyle" | "searchArea" | "singleImageModeSettings";
export declare type AttributeDescriptor = StringValue | BooleanValue | IntegerValue | ArrayValue | VideoFitValue | CameraValue | CameraSettings | CameraTypeValue | GuiStyleValue | SearchAreaValue | SingleImageModeSettingsValue;
